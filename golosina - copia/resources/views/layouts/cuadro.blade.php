      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        ...
        @auth
                ...
                <ul class="dropdown-menu">
                  <li class="nav-item">
                      <a class="nav-link" href="/faq">Caramelos</a>
                  </li>
                  <li class="nav-item">
                      <a class="nav-link" href="/#tortas">Chocolates</a>
                  </li>
                  <li class="nav-item">
                      <a class="nav-link" href="/#pricing">Chupetines</a>
                  </li>
                  <li class="nav-item">
                      <a class="nav-link" href="/#pricing">Galletitas</a>
                  </li>
                  <li class="nav-item">
                      <a class="nav-link" href="/#pricing">Alfajores</a>
                  </li>
                  <li class="nav-item">
                      <a class="nav-link" href="/candys">Bebidas</a>
                  </li>
                </ul>
